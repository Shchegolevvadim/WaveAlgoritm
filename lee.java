...
public class lee
{
    // Здесь мы задаем размер по столбцу и строке введённой матрицы
    static int M = 5;
    static int N = 5;
    ...
    private static void bfs(int matrix[][], int i, int j, int x, int y)
    {
        ...
        {
            System.out.print("Путь не может быть найден");
        }
        else
        {
            System.out.print("Кратчайший путь равен " + minimum_distance);
        }
    }
